      ...
      <div className="mx-auto w-full overflow-hidden rounded-xl px-8 py-10 shadow-2xl lg:max-w-xl bg-primary dark:bg-dark text-off-white">
        <div className="flex-1">
          ...
          <input 
            ...
            type="text" 
            placeholder="Subject" 
            className="mt-2 block w-full rounded-md bg-primary-dark dark:bg-black/50 px-5 py-3 placeholder-off-white/30 font-thin" 
            required
          />
        </div>
        ...
        <div className="mt-6 flex-1">
          ...
          <input name="email" 
            ...
            id="email" 
            className="mt-2 block w-full rounded-md px-5 py-3 bg-primary-dark dark:bg-black/50 placeholder-off-white/30 font-thin"
            required
          />
        </div>
        ...
        <div className="mt-6 w-full">
          ...
          <textarea 
            ...
            onChange={handleChange} 
            className="mt-2 block h-32 w-full rounded-md py-3 px-5 md:h-48 bg-primary-dark dark:bg-black/50 placeholder-off-white/30 font-thin" 
            placeholder="Message"
            required
            ></textarea>
        </div>
