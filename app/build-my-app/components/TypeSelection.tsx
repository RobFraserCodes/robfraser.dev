    ...
    return (
        <div className='dark:text-white'>
            ...
            <div className="text-center m-10 p-4 rounded-md shadow-md hover:bg-primary bg-off-white">
                <Image width={300}  height={400} src="/enquiry/mobile-step-1.png" alt="Mobile application mockup" 
            ...
            <div className="text-center m-10 p-4 rounded-md shadow-md hover:bg-primary bg-off-white">
                <Image width={700} height={300} src="/enquiry/desktop-step-1.png" alt="Website application mockup" 
